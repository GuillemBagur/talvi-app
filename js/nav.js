...
const drawNav = () => {
    const navLinks = [
        ...
        {name: "Tickets", icon: `<i class="nav__icon ri-camera-line"></i><input type="file" id="image-input" class="take-picture-input" name="image" accept="image/*" capture="environment">`, url: "/home", className: "nav__link--middle"},
